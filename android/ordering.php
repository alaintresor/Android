...
if (isset($_POST["proId"])) {
  ...
  while ($row = mysqli_fetch_array($product)) {
    ...
    if ($_POST["proQty"] > $tee) {
      ...
      $query = "INSERT INTO `orders` (`id`, `cust_id`, `p_id`, `p_qty`, `p_Uprice`, `total_price`,`day`,`month`,`year`,`time`) VALUES (NULL, '{$_POST["userId"]}', '{$_POST["proId"]}', '{$_POST["proQty"]}', '{$_POST["proPrice"]}', '$totalPrice','$day','$month','$year','$time');";
