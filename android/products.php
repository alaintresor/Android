            ...
            <table class="table table-striped table-hover">
              <tbody>
                ...
                <?php while ($row = mysqli_fetch_array($data)) { ?>
                  <tr><td><?php echo $row[1]; ?></td><td><?php echo $row[2]; ?></td><td><?php echo $row[3]; ?></td><td><?php echo $row[4]; ?></td><td><?php echo $row[7]; ?></td><td align='right'><a href=''> Edit</a></td><td align='right'> <a href='deleteProduct.php?id=<?php echo $row[0]; ?>'> Delete</a></td></tr>
               <?php  }  ?>
              </tbody>
            </table>
<img src="">
