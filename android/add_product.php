...
if (isset($_POST['name'])) {
   ...
   if (in_array($imageFileType, $extensions_arr)) {
      ...
      $query = "INSERT INTO `product` (`id`, `p_name`, `p_qty`, `p_Uprice`, `description`, `image`, `shareholder_id`, `category`, `status`,`date`) VALUES (NULL, '$names', '$qty', '$price', '$desc','$fullpath','$owner', '$category', '$status','$date');";
